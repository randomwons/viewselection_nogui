...
py::array_t<double> VoxelGrid::occlusion_aware(int32_t height, int32_t width,
...
py::array_t<double> VoxelGrid::unobserved_voxel(int32_t height, int32_t width,
                                               py::array_t<double> intrinsic_, py::array_t<double> pose_) const {
    ...
    for(int i = 0; i < height * width; i++){
        ...
        while(!sample.is_hit()){
            if(sample.is_valid(dims)){
                ...
                double Iu_xi = (curVoxel.occLogOdd > L_FREE && curVoxel.occLogOdd < L_OCCUPIED) ? 1 : 0;
                double Po_xi = probability(curVoxel.occLogOdd);
                double Io_xi = entropy(Po_xi);
                double Iv_xi = Io_xi * Pv_xi;
...
py::array_t<double> VoxelGrid::rear_side_voxel(int32_t height, int32_t width,
                                               py::array_t<double> intrinsic_, py::array_t<double> pose_) const {
...
py::array_t<double> VoxelGrid::rear_side_entropy(int32_t height, int32_t width,
                                               py::array_t<double> intrinsic_, py::array_t<double> pose_) const {
...
py::array_t<double> VoxelGrid::krigel(int32_t height, int32_t width,
                                               py::array_t<double> intrinsic_, py::array_t<double> pose_) const {
...
py::array_t<double> VoxelGrid::proximity_count(int32_t height, int32_t width,
                                               py::array_t<double> intrinsic_, py::array_t<double> pose_) const {
